  ...
  return (
    <FadeIn delay={1.2}>
      <div id="lead-form" className="w-full max-w-2xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 scroll-mt-8">
        {/* Header Section */}
        <Shimmer className="bg-gradient-to-r from-metallic-gold to-old-gold p-6 text-center">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
        ...
        <StaggerItem>
          <Shimmer className="bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-lg transition-shadow duration-300">
