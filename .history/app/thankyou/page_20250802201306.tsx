    ...
    <div className="min-h-screen bg-gradient-to-br from-cream-gold to-light-gold" dir="rtl">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        ...
        <div className="text-center mb-12">
          ...
          {leadData && (
            <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 border-2 border-metallic-gold mb-8 max-w-lg mx-auto">
              ...
              <div className="space-y-3 text-right">
                ...
                <div className="border-t border-gray-200 pt-3 mt-4">
                  <div className="flex justify-between items-center">
                    <span className="text-body text-traditional-brown">سعر الرف الواحد:</span>
                    <span className="text-body font-semibold text-chocolate-brown">325 ريال</span>
                  </div>
                  <div className="flex justify-between items-center mt-2">
                    <span className="text-lg font-bold text-chocolate-brown">المجموع الكلي:</span>
                    <span className="text-xl font-bold text-metallic-gold">
                      {(() => {
                        const quantity = parseInt(String(leadData.quantity || '0'));
                        const unitPrice = 325;
