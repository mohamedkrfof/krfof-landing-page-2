        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 relative">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            ...
            <p className="text-xl sm:text-2xl md:text-3xl text-traditional-brown mb-8 sm:mb-12 leading-relaxed max-w-4xl mx-auto font-medium">
              رفوف تخزين خفيفة إلى متوسطة التحمل بمواصفات احترافية
              <span className="block text-lg sm:text-xl md:text-2xl text-warm-brown mt-2 font-semibold">
                  تتحمل حتى 200 كيلو لكل رف مع ضمان لمدة عام كامل
              </span>
            </p>
            ...
            {/* Urgency Banner - Classic Gold with Chocolate Brown for Maximum Impact */}
            <div className="bg-gradient-to-r from-classic-gold to-metallic-gold text-chocolate-brown p-4 sm:p-6 rounded-2xl shadow-lg mb-8 sm:mb-12 max-w-3xl mx-auto">
              <div className="text-center">
                <div className="flex items-center justify-center mb-3">
                  <Clock className="w-5 h-5 sm:w-6 sm:h-6 ml-2" />
                  <span className="text-lg sm:text-xl font-bold">عرض محدود - ينتهي قريباً!</span>
                </div>
                <p className="text-base sm:text-lg mb-3">
                  خصم خاص علي الكميات  + تركيب مجاني
                </p>
                <div className="bg-chocolate-brown/20 backdrop-blur-sm p-3 rounded-lg inline-block">
                  <div className="flex items-center justify-center space-x-4 space-x-reverse text-sm sm:text-base">
                    <div className="text-center">
                      <div className="text-xl sm:text-2xl font-bold">07</div>
